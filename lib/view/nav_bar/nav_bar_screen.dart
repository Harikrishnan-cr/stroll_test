...
class NavBarScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:
          _children[Provider.of<BottomNavController>(context).getCurrentIndex],
      bottomNavigationBar:
          ...
          items: [
            const BottomNavigationBarItem(
              ...
              activeIcon: CustomSvgIcon(
                  imgPath: StrolSvg.cardsIcon, color: StrollColors.whiteColor),
            ),
            const BottomNavigationBarItem(
              label: '',
              icon: CustomSvgIcon(imgPath: StrolSvg.flamesSvg),
              activeIcon: CustomSvgIcon(
                  imgPath: StrolSvg.flamesSvg, color: StrollColors.whiteColor),
            ),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: StrollColors.blackColor, width: 1.5)),
                        child: Center(
                            child: Text(
                          '10',
                          style: fontStyle.blackColor.w700.s7,
                        )),
                      ),
                    ),
                  ],
            ...
            const BottomNavigationBarItem(
              ...
              activeIcon: CustomSvgIcon(
                  imgPath: StrolSvg.userSvg, color: StrollColors.whiteColor),
            ),
          ],
        );
      }),
